...
#####################################################
# Paqet Tunnel Server Setup Script (Foreign Server)
...
echo -e "${BLUE}╔═══════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  Paqet Tunnel Server Automated Setup (Foreign)   ║${NC}"
echo -e "${BLUE}╔═══════════════════════════════════════════════════╗${NC}"
echo ""
...
apt-get update -qq
apt-get install -y curl wget jq tar iptables iptables-persistent libpcap0.8 libpcap-dev &>/dev/null
...
# Create paqet server config - EXTREME SPEED MODE
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}Save the Secret Key - you'll need it for client setup!${NC}"
echo ""
